...
namespace CWB.ProductionPlanWO.Infrastructure
{
    public class WODbContext : DbContext
    {
        ...
        public WODbContext(DbContextOptions<WODbContext> options, IHttpContextAccessor httpContextAccessor)
           : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfigurationsFromAssembly(typeof(WODbContext).Assembly);
        }
