...
{
    public class ProductionPlan_WOConfiguration : IEntityTypeConfiguration<ProductionPlan_WO>
    {
        public void Configure(EntityTypeBuilder<ProductionPlan_WO> builder)
        {
            builder
                .ToTable("ProductionPlan_WO");
            builder
                .HasKey(w => w.Id);
            builder
              .Property(t => t.PPNumber)
