...
{
    public class BusinessProcessesDbContext : DbContext
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        public BusinessProcessesDbContext(DbContextOptions<BusinessProcessesDbContext> options, IHttpContextAccessor httpContextAccessor)
           : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfigurationsFromAssembly(typeof(BusinessProcessesDbContext).Assembly);
        }
