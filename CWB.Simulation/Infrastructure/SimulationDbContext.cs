...
namespace CWB.Simulation.Infrastructure
{
    public class SimulationDbContext : DbContext
    {
        ...
        public SimulationDbContext(DbContextOptions<SimulationDbContext> options, IHttpContextAccessor httpContextAccessor)
           : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfigurationsFromAssembly(typeof(SimulationDbContext).Assembly);
        }
