...
namespace CWB.Masters.Infrastructure
{
    public class MastersDbContext : DbContext
    {
        ...
        public MastersDbContext(DbContextOptions<MastersDbContext> options, IHttpContextAccessor httpContextAccessor)
           : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfigurationsFromAssembly(typeof(MastersDbContext).Assembly);
        }
