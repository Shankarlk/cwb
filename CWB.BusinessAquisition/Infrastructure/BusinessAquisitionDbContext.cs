...
{
    public class BusinessAquisitionDbContext : DbContext
    {
        private readonly IHttpContextAccessor _httpContextAccessor;
        public BusinessAquisitionDbContext(DbContextOptions<BusinessAquisitionDbContext> options, IHttpContextAccessor httpContextAccessor)
           : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.ApplyConfigurationsFromAssembly(typeof(BusinessAquisitionDbContext).Assembly);
        }
